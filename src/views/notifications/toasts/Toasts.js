        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz/docs/utilities/api">utilities</a>, or by adding your own
              markup. Here we&#39;ve created a simpler toast by removing the default{' '}
              <code>&lt;CToastHeader&gt;</code>, adding a custom hide icon from{' '}
              <a href="https://www.maximo.co.mz/icons/">CoreUI Icons</a>, and using some{' '}
              <a href="https://www.maximo.co.mz/docs/utilities/flex">flexbox utilities</a> to adjust the
              layout.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz/docs/utilities/colors">color</a> and{' '}
              <a href="https://www.maximo.co.mz/docs/utilities/background">background</a> utilities. Here
