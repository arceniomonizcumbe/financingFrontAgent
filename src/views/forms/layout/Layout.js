    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              By adding <a href="https://www.maximo.co.mz/docs/layout/gutters/">gutter modifier classes</a>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              As shown in the Anterior examples, our grid system allows you to place any number of{' '}
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              layouts. By adding{' '}
              <a href="https://www.maximo.co.mz/docs/layout/gutters/">gutter modifier classes</a>, we will
