          ...
          <CCardBody>
            ...
            <DocsExample href="components/pagination">
              <CPagination aria-label="Page navigation example">
                <CPaginationItem>Anterior</CPaginationItem>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/pagination#working-with-icons">
              <CPagination aria-label="Page navigation example">
                <CPaginationItem aria-label="Anterior">
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/pagination#disabled-and-active-states">
              <CPagination aria-label="Page navigation example">
                <CPaginationItem aria-label="Anterior" disabled>
                  <span aria-hidden="true">&laquo;</span>
                </CPaginationItem>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz/docs/utilities/flex/">flexbox utilities</a>.
            </p>
