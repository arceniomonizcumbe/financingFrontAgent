        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz/docs/layout/grid/#horizontal-alignment">
                flexbox utilities
              </a>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz/docs/utilities/flex">flexbox utilities</a>. While
              more verbose, these utilities offer greater customization across responsive
              breakpoints. In the example below, our nav will be stacked on the lowest breakpoint,
              then adapt to a horizontal layout that fills the available width starting from the
              small breakpoint.
            </p>
