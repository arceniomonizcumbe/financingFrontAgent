        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Adding in the Anterior and Next controls by <code>controls</code> property.
            </p>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz//utilities/display">display utilities</a>. We hide them
