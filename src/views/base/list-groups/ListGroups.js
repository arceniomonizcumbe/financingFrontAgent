        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              ...
              in the Anterior example. Also supported is the <code>active</code> state; apply it to
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              help of <a href="https://www.maximo.co.mz/docs/utilities/flex/">flexbox utilities</a>.
            </p>
