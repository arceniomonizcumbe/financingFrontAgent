        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <a href="https://www.maximo.co.mz/docs/utilities/spacing">spacing utilities</a> as
              needed. They have no fixed width to start, so they&#39;ll fill the full width of its
              parent.
            </p>
            <p className="text-body-secondary small">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              Use some of{' '}
              <a href="https://www.maximo.co.mz/docs/utilities/sizing/">
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              parts—with{' '}
              <a href="https://www.maximo.co.mz/docs/utilities/text/#text-alignment">
                text align classes
              </a>
              .
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <h3>Border</h3>
            <p className="text-body-secondary small">
              Use <a href="https://www.maximo.co.mz/docs/utilities/borders/">border utilities</a> to
